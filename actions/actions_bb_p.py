...
class ActionDataBeratbadanPria(Action):
    def name(self):
        return "action_data_beratbadan_pria"
    ...
    def run(self, 
        ...
        if umur > 0 and umur <= 24:
            dispatcher.utter_message(image="https://i.ibb.co/1LvjcHz/image.png")
        else:
            dispatcher.utter_message(image="https://i.ibb.co/JW1VCGK/image.png")
